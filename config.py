...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "22287041")
    API_HASH  = os.environ.get("API_HASH", "c149386dcd58a40fa9fe60e632e161d422287041")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6936293249:AAE3n0pclyXVGwfnvbkJ_m7X-ecjo6YISGw")
